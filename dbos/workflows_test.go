...
func TestSpecialSteps(t *testing.T) {
	...
	t.Run("SpecialStepsExecution", func(t *testing.T) {
		...
		require.Equal(t, "DBOS.listWorkflows", steps[2].StepName, "third step should be DBOS.listWorkflows")
		require.Equal(t, "DBOS.listWorkflows", steps[3].StepName, "fourth step should be DBOS.listWorkflows")
